    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 text-white">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-3">
        ...
        <p className="text-sm sm:text-base text-slate-300">
          Our 5-pillar curriculum integrates sacred sciences, competitive mainstream academics, moral tarbiyah, and practical life skills.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-slate-900 border border-slate-800 p-8 text-center space-y-4">
        ...
        <h3 className="text-2xl font-bold font-['Cinzel',serif]">
          Prepare Your Child for Success in Both Worlds
        </h3>
        <p className="text-xs sm:text-sm text-slate-300 max-w-xl mx-auto">
          Enroll in Al-Dahr Academy for the upcoming academic session. Admissions open for Classes 1 to 8.
        </p>
        <button
